...
with app.app_context():
    ...
    users = [
        ...
        {'username': 'specht11', 'email': 'specht11@umd.edu', 'first_name': 'Jensen', 'last_name': 'Specht',
         'password': generate_password_hash('specht11', method='pbkdf2:sha256'), 'role': 'STUDENT'}
    ]
    ...
    students = [
        ...
        {'first_name': 'Jensen', 'last_name': 'Specht', 'email': 'specht11@umd.edu',
         'major_id': 3, 'birth_date': dt.strptime('2005-06-25', '%Y-%m-%d'), 'is_honors': 1}
    ]
